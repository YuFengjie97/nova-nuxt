...
#iChannel1 "file://D:/workspace/nova-nuxt/shaderToy/发光粒子/bufferB.glsl"
...
void mainImage(out vec4 O, in vec2 I){
  ...
  vec2 U = I / R.xy;
  vec3 col_buf = texture(iChannel0, U).rgb;
  col += col_buf;

  vec3 col_last = texture(iChannel1, U).rgb*.9;
  col += col_last;
